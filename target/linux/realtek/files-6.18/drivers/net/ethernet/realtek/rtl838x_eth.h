...
#define RTL93XX_CPU_TAG1_BYPASS_FILTER		BIT(3)
#define RTL93XX_CPU_TAG1_IGNORE_STP_MASK	GENMASK(2, 2)
#define RTL93XX_CPU_TAG1_BYPASS_VLAN_EGR	BIT(1)

#define RTL931X_CPU_TAG2_SPN			GENMASK(9, 0)
#define RTL931X_CPU_TAG2_SPN_DEVICE		GENMASK(9, 6)
#define RTL931X_CPU_TAG2_SPN_PORT		GENMASK(5, 0)
#define RTL931X_CPU_TAG4_SW_UNIT			GENMASK(11, 8)
